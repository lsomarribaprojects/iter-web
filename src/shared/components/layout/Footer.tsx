  ...
  return (
    <footer className="bg-slate-800 text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-8 pt-8 border-t border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center space-x-3">
              <MapPin className="h-5 w-5 text-electric-500 flex-shrink-0" />
        ...
        {/* Sinsajo Creators Credits */}
        <div className="mt-8 pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/40 gap-4">
            <p>Desarrollado con excelencia técnica y pasión por la innovación</p>
            <p>
              Creado por{' '}
              <a
                href="https://sinsajocreators.com"
                target="_blank"
                rel="noopener noreferrer"
                className="text-electric-400 hover:text-electric-300 transition-colors duration-300 underline decoration-electric-400/30 hover:decoration-electric-300 font-medium"
              >
                Sinsajo Creators
              </a>
            </p>
